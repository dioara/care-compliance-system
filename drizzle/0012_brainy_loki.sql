...
--> statement-breakpoint
ALTER TABLE `aiAudits` ADD `anonymizationReport` text;--> statement-breakpoint
ALTER TABLE `staffMembers` ADD `employmentType` enum('permanent_sponsored','permanent_not_sponsored','agency') DEFAULT 'permanent_not_sponsored';--> statement-breakpoint
ALTER TABLE `tenants` ADD `openaiApiKey` varchar(255);