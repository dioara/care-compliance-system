...
export const aiAudits = mysqlTable("aiAudits", {
	...
	serviceUserFirstName: varchar({ length: 100 }),
	serviceUserLastName: varchar({ length: 100 }),
	replaceFirstNameWith: varchar({ length: 100 }),
	replaceLastNameWith: varchar({ length: 100 }),
	keepOriginalNames: tinyint().default(0),
	consentConfirmed: tinyint().default(0),
