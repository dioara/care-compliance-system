          ...
          <div className="lg:col-span-8">
            <Card className="bg-white shadow-xl border-0 overflow-hidden">
              ...
              <div className="prose prose-lg prose-indigo max-w-none
                ...
                prose-h1:text-4xl prose-h1:mt-0 prose-h1:mb-10 prose-h1:pb-6 prose-h1:border-b-2 prose-h1:border-indigo-200 prose-h1:leading-tight
                prose-h2:text-2xl prose-h2:mt-16 prose-h2:mb-6 prose-h2:pt-8 prose-h2:pb-4 prose-h2:border-t prose-h2:border-gray-200 prose-h2:text-indigo-900 prose-h2:leading-tight
                prose-h3:text-xl prose-h3:mt-10 prose-h3:mb-4 prose-h3:text-gray-800 prose-h3:font-semibold prose-h3:leading-snug prose-h3:pl-4 prose-h3:border-l-4 prose-h3:border-indigo-400
                prose-h4:text-lg prose-h4:mt-8 prose-h4:mb-3 prose-h4:text-gray-700 prose-h4:font-semibold prose-h4:leading-snug
                prose-p:text-gray-700 prose-p:leading-[1.85] prose-p:mb-5 prose-p:text-[17px]
                prose-strong:text-gray-900 prose-strong:font-semibold
                prose-ul:my-6 prose-ul:space-y-3 prose-ul:pl-6
                prose-ol:my-6 prose-ol:space-y-3 prose-ol:pl-6
                prose-li:text-gray-700 prose-li:text-[17px] prose-li:leading-[1.85] prose-li:pl-2
