...
## Audit Calendar Feature (Dec 16, 2025)
- [x] Create database schema for audit calendar events
- [x] Create Audit Calendar page with monthly/weekly calendar view
- [x] Implement audit scheduling functionality (auto-suggest dates for next year)
- [x] Add ability to create/edit/delete calendar events
- [x] Add calendar navigation and filters
- [ ] Implement auto-reminders 1 day before scheduled audits (requires cron job setup)

## Action Plan Email Notifications (Dec 16, 2025)
- [ ] Set up email service integration (SendGrid)
- [ ] Create email templates for action plan notifications
- [ ] Send notification when action is assigned to a person
- [ ] Send reminder when action is approaching due date (3 days before)
- [ ] Send notification when action is marked complete
- [ ] Add email preferences in user settings

## Enhanced Breadcrumb Navigation (Dec 16, 2025)
- [ ] Update Breadcrumb component to support dynamic paths
- [ ] Add breadcrumbs to all major pages (Dashboard, Staff, Service Users, Incidents, Audits, Reports)
- [ ] Show hierarchy for detail pages (e.g., "Staff > Sarah Williams")
